...
| Подвижная рука | `Assets/Scenes/P2_DigitalTwin.unity` | `GFSX_Brain_Mobile` | 6 (+ S1, S2, S3) |
...
- **Рука (MobileArm):** команды S1/S2/S3 масштабируются по дистанции до мяча (полная сила ближе ~0.85 м, ослабление дальше ~1.8 м). Далеко от мяча — штраф за движение рукой; близко — небольшая награда за активную руку.
